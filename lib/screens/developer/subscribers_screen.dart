      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text('• Delete all owner and user accounts'),
            const Text('• Delete all products and inventory'),
            const Text('• Delete all sales records'),
            const Text('• Delete all CCTV and attendance data'),
            const Text('• Reset the system to initial state'),
            const SizedBox(height: 12),
            const Text(
