...
class DeliveryReceiverDashboard extends StatelessWidget {
  final User user;
  const DeliveryReceiverDashboard({super.key, required this.user});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(AppLocalizations.t('delivery_receiver'))),
      body: Center(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      ...
                      _ActionTile(
                        ...
                        color: Colors.green,
                        title: AppLocalizations.t('supplier_management'),
