  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'privacy_data_storage_content':
          'All data is stored locally using SQLite database on your device. No cloud storage or external servers are used. Data persists until manually deleted by authorized administrators. CCTV footage is stored based on available device storage capacity. You have full control over data retention and deletion.',
...
Visit: www.pinkoradev.com''',
    ...
    'fil': {
      ...
      'privacy_data_storage_content':
          'Lahat ng datos ay naka-imbak nang lokal gamit ang SQLite database sa iyong device. Walang cloud storage o external servers na ginagamit. Ang datos ay nananatili hanggang sa manu-manong tanggalin ng awtorisadong administrators. Ang CCTV footage ay naka-imbak batay sa available na storage capacity ng device. Mayroon kang ganap na kontrol sa data retention at deletion.',
